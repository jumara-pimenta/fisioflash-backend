    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sexo', models.CharField(choices=[('M', 'Masculino'), ('F', 'Feminino'), ('O', 'Outro')], db_column='sexo', default='F', max_length=1)),
                ...
                ('curriculo', models.FileField(blank=True, db_column='curriculo', null=True, upload_to='curriculos/')),
